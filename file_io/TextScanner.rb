class TextScanner
  ...
  def clean
    contents.gsub!("\n", '') if contents.include?("\n")
    contents.gsub!(/\W/,' ') if contents.include?(/\W/)
    contents.gsub!('  ',' ') if contents.include?('  ')
  end
...
alice = File.open("alice.txt","w")
alice.write("Alice was beginning to get very tired of sitting by her sister on
